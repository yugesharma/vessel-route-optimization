...
function Sidebar({startPoint, endPoint}: SidebarProps) {
  ...
  return (
    <div className="sidebar">
      ...
      <input type="text" id="start" name="start" placeholder="Enter start location" value= {startPoint ? `${startPoint[0].toFixed(4)}, ${startPoint[1].toFixed(4)}` : ''} />
      </div>
      <div className="form-group">
      <label htmlFor="end">End Location:</label>
      <input type="text" id="end" name="end" placeholder="Enter end location" value= {endPoint ? `${endPoint[0].toFixed(4)}, ${endPoint[1].toFixed(4)}` : ''} />
      </div>
      <div className="form-group">
